...
WORKDIR /app
COPY . ./
RUN dotnet publish ./Kemocade.Vrc.Group.Tracker.Action/Kemocade.Vrc.Group.Tracker.Action.csproj -c Release -o out --no-self-contained

# Label the container
LABEL maintainer="Dustuu <dustuu@kemocade.com>"
LABEL repository="https://github.com/kemocade/Kemocade.Vrc.Group.Tracker.Action"
...
ENTRYPOINT [ "dotnet", "/Kemocade.Vrc.Group.Tracker.Action.dll" ]